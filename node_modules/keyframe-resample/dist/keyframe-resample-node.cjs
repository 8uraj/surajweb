...
const wasmURL = /* #__PURE__ */new URL('./release.wasm', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('keyframe-resample-node.cjs', document.baseURI).href)));
const wasm = /* #__PURE__ */promises.readFile(wasmURL);
...
const ready = /* #__PURE__ */new Promise(async (resolve, reject) => {
  try {
    ...
    exports$1 = await instantiate(module, {});
    resolve();
  } catch (e) {
    reject(e);
  }
